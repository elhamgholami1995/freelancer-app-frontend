        ...
        <div>
          ...
          <input
            ...
            className="w-full py-3 px-4 rounded-xl text-secondary-900
             border border-gray-300 outline-none hover:border-primary-500
           focus:border-primary-500 focus:bg-white transition-all duration-300 ease-in-out focus:shadow-lg focus:shadow-primary-200"
            type="text"
          />
        </div>
